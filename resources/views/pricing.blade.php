                    ...
                    <section class="container mx-auto flex flex-wrap">
                        <div class="lg:w-1/3 md:w-1/2 w-full p-4 ">
                            <div class="p-8 rounded-xl shadow-md border border-gray-200 bg-white">
                                ...
                                <form action="{{ route('pricing.post') }}" method="post">
                                    @csrf
                                    <input value="5" name="amount" hidden>
                                    <button type="submit" class="my-4 px-4 py-2 block w-full text-white bg-gray-800 hover:bg-gray-700 rounded"> Purchase </button>
                                </form>
                            </div>
                        </div>
                        <div class="lg:w-1/3 md:w-1/2 w-full p-4 ">
                            <div class="p-8 rounded-xl bg-white shadow-md border border-gray-200">
                                ...
                                <form action="{{ route('pricing.post') }}" method="post">
                                    @csrf
                                    <input value="9" name="amount" hidden>
                                    <button type="submit" class="my-4 px-4 py-2 block w-full text-white bg-gray-800 hover:bg-gray-700 rounded"> Purchase </button>
                                </form>
                            </div>
                        </div>
                        <div class="lg:w-1/3 md:w-1/2 w-full p-4 ">
                            <div class="p-8 rounded-xl shadow-md bg-white border border-gray-200">
                                ...
                                <form action="{{ route('pricing.post') }}" method="post">
                                    @csrf
                                    <input value="20" name="amount" hidden>
                                    <button type="submit" class="my-4 px-4 py-2 block w-full text-white bg-gray-800 hover:bg-gray-700 rounded"> Purchase </button>
                                </form>
                            </div>
                        </div>
